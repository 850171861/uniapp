<template>
	<view>
		...
		<!-- 选择规格 -->
		<view class="info-box">
			<!-- @tap="spaceInfo.showSpace = true" 点击弹出模态框 -->
		...
		<!-- 模态框 -->
		<popupSpec @add="add" @sub="sub" @setSelectSpec="setSelectSpec"
		 @hideSpec="hideSpec" :goodsInfo="goodsInfo"
		...
		<view class="footer">
			...
			<view class="btn">
				...
				<view @tap="bandleBuy" class="buy">立即购买</view>
			</view>
		</view>
	</view>
...
<script>
	...
	export default{
		...
		methods:{	
			...
			initData(){
				this.request({
					//请求轮播图 码数 评论【 图片 评论内容 评论名字 】
					url:'https://www.wudongming.top/uni/goods',
					success:((res)=>{
